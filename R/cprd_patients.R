...
#' criteria:
#' 1. crd < start of window
#' 2. tod > end of window
#' 3. deathdate > end of window
#' @param db a database connection
#' @param startdate character for the start of the window (format "%Y-%m-%d")
#' @param startdate character for the end of the window (format "%Y-%m-%d")
#' @param registration_buffer numeric how many days must patients be registered for prior to the startdate to be included? 
#' Setting a posive value can reduce information bias 
